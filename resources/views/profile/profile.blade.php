    ...
    <div class="container-style">
        ...
        @if (session('status') == 'profile-updated')
            <x-notification.badge-message class="mt-2" messages="General information updated successful" type="success"
                animation="animationTemporaryShow" />
        @elseif(count($errors) > 0)
            <x-notification.badge-message class="mt-2" messages="Updated failed" type="danger" />
                ...
                <div class="col-md-12" style="display: flex">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="vendor_name" name="vendor_name"
                                    value="{{ old('vendor_name', Auth()->user()->vendor->VM_NAME) }}" disabled>
                            ...
                            <div class="col-sm-8">
                                <select type="text" class="form-control" name="product_community"
                                    ...
                                    @foreach ($product_community as $row)
                                        <option value="{{$row->PC_ID}}" @if (old('product_community', Auth()->user()->vendor->VM_COMMUNITY) == $row->PC_ID) selected @endif>
                                            {{$row->PC_NAME}}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="product_range" name="product_range"
                                    value="{{ old('product_range', Auth()->user()->vendor->VM_PRODUCTRANGE) }}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea type="text" class="form-control" id="address" name="address" disabled>{{ old('address', Auth()->user()->vendor->VM_ADDRESS) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="country" name="country"
                                    value="{{ old('country', Auth()->user()->vendor->VM_COUNTRY) }}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="city" name="city"
                                    value="{{ old('city', Auth()->user()->vendor->VM_CITY) }}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="phone" name="phone"
                                    value="{{ old('phone', Auth()->user()->vendor->VM_PHONE) }}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="facsimile" name="facsimile"
                                    value="{{ old('facsimile', Auth()->user()->vendor->VM_FACSIMILE) }}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="url" class="form-control" id="website" name="website"
                                    ...
                                    value="{{ old('website', Auth()->user()->vendor->VM_WEBSITE) }}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="postal_code" name="postal_code"
                                    value="{{ old('postal_code', Auth()->user()->vendor->VM_POSTAL_CODE) }}" disabled>
                ...
                <div class="col-md-12" style="display: flex">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="cp_mobile_phone" name="cp_mobile_phone"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="cp_facsimile" name="cp_facsimile"
